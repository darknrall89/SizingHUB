...
const TOOLS=[
  ...
  {id:"switch",  label:"Switch Fabric",    icon:Network,  section:"RÉSEAU",         comp:SwitchFabric,badge:"Switch",    sub:"Fabric · VLAN · QoS"},
...
export default function SizingHub() {
  ...
  return (
    <div style={{fontFamily:"'Inter',system-ui,sans-serif",background:th.bg0,color:th.t1,minHeight:"100vh",display:"flex",transition:"background 0.2s,color 0.2s",position:"relative"}}>
      ...
      {/* Sidebar */}
      <div style={{width:isMobile?210:210,minWidth:isMobile?210:210,background:th.bg1,borderRight:`1px solid ${th.border}`,display:"flex",flexDirection:"column",padding:"16px 0",transition:"all 0.3s",position:isMobile?"fixed":"sticky",top:0,left:0,height:"100vh",zIndex:999,transform:isMobile&&!menuOpen?"translateX(-100%)":"translateX(0)",overflowY:"auto"}}>
